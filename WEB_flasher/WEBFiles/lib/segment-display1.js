    ...
    if (context) {
      ...
      if (this.pattern) {
        for (var i = 0; i < this.pattern.length; i++) {
		  ...
		  var c = this.pattern.charAt(i).toUpperCase();
          if (c == '#') {
  ...
  switch (mask) {
    case '#':
      ...
      if (this.segmentCount == 16) {
        ...
        var x = xPos;
        var y = 0;
        context.fillStyle = this.getSegmentColor(c, '*', '02356789abcdefgiopqrstz@');
        context.beginPath();
      ...
      context.fillStyle = this.getSegmentColor(c, '013456789abdhnuyo', '01346789abdghjmnoqsuw@', '%');
      context.beginPath();
      ...
      if (this.segmentCount == 16) {
        ...
        x = xPos;
        y = this.digitHeight - this.segmentWidth;
        context.fillStyle = this.getSegmentColor(c, '0235689bcdeltuy_o', '0235689bcdegijloqsuz_=@');
        context.beginPath();
        context.moveTo(x + this.segmentWidth + d, y);
        context.lineTo(x + this.digitWidth - this.segmentWidth - d, y);
        switch (this.cornerType) {
      ...
      x = xPos;
      y = h + this.segmentWidth;
      context.fillStyle = this.getSegmentColor(c, '0268abcdefhlnprtuo', '0268acefghjklmnopqruvw@');
      context.beginPath();
      context.moveTo(x, y + this.segmentWidth + d);
      context.lineTo(x + s, y + s + d);
      context.lineTo(x + this.segmentWidth, y + this.segmentWidth + d);
